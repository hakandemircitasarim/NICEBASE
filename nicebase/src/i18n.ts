...
const resources = {
  tr: {
    translation: {
      ...
      authEmailNotConfirmed: 'Lütfen önce e-posta adresini doğrula.',
      authEmailInUse: 'Bu e-posta zaten kayıtlı.',
      authWeakPassword: 'Şifre en az 6 karakter olmalı.',
      authRateLimited: 'Çok fazla deneme yapıldı. Lütfen biraz sonra tekrar dene.',
      authNetworkError: 'Bağlantı sorunu yaşandı. İnternetini kontrol et.',
      ...
      connectionMemoryCount_one: '{{count}} anı',
      connectionMemoryCount_other: '{{count}} anı',
      ...
      memoriesDeleted_one: '{{count}} anı silindi',
      memoriesDeleted_other: '{{count}} anı silindi',
      ...
      acceptTerms: 'Şunları kabul ediyorum:',
      ...
      dataDeletion: 'Hesap ve Veri Silme',
      legal: 'Yasal',
      ...
      loginRequiredForReminders: 'Hatırlatıcılar için giriş yapmanız gerekiyor',
      ...
      viewPhoto: 'Fotoğrafı görüntüle ({{n}})',
      hoursLabel: 'Saat',
      minutesLabel: 'Dakika',
      setValueTo: 'Değeri {{value}} yap',
      sliderValue: 'Değer',
      googleSignInUnavailable: 'Google ile giriş şu anda kullanılamıyor',
      ...
      onThisDay: 'bugün',
      memoriesOnThisDay_one: '{{count}} anı',
      memoriesOnThisDay_other: '{{count}} anı',
      ...
      aiyaLimitReached: 'Aiya ile bu haftalık sohbet hakkını kullandın. Aiya seninle konuşmayı çok seviyor 💛, sınırsız devam etmek istersen Premium tam sana göre, ya da hafta yenilenince yine buradayız.',
      aiyaRateLimited: 'Çok hızlı gidiyorsun 🙂 Lütfen birkaç saniye sonra tekrar dene.',
      aiyaRetry: 'Tekrar dene',
      aiyaRemaining_one: '{{count}} mesaj kaldı',
      aiyaRemaining_other: '{{count}} mesaj kaldı',
      aiyaRenameChat: 'Yeniden Adlandır',
      aiyaWhatRemembers: 'Aiya seni nasıl tanıyor',
      aiyaClearMemory: 'Aiya hafızasını temizle',
      aiyaMemoryCleared: 'Aiya hafızası temizlendi',
      aiyaNoProfile: 'Aiya seni tanımak için henüz yeterli bilgiye sahip değil. Sohbet ettikçe seni daha iyi tanıyacak.',
      aiyaChatsLoadError: 'Sohbetler yüklenemedi',
      photoTooLarge: 'Fotoğraf çok büyük. 10MB sınırını aşıyor (mevcut: {{size}}MB)',
      photoUploadRateLimited: 'Çok fazla fotoğraf yükleme isteği. Lütfen bir süre bekleyin.',
      replayTutorial: 'Eğitimi Tekrar İzle',
      retryBackups: 'Yedeklemeyi Tekrar Dene',
      retryingBackups: 'Yedekleniyor...',
      backupIssuesTitle: 'Bazı anılar yedeklenmedi',
      backupIssuesMessage: '{{count}} anı yedeklenemedi. Tekrar denemek için dokunun.',
      backupRetryPartial: '{{count}} anı yedeklenemedi',
      backupRetrySuccess: 'Tüm anılar yedeklendi',
      textMaxLength: 'Metin en fazla {{count}} karakter olabilir',
      noRecentMonthlyData: 'Son 6 ayda eklenmiş anı yok',
      aiyaNetworkError: 'Bağlantı sorunu yaşandı. İnternetini kontrol edip tekrar dene.',
      aiyaTyping: 'Aiya yazıyor...',
      aiyaChatOptions: 'Sohbet seçenekleri',
      aiyaCrisisTitle: 'Yalnız değilsin',
      aiyaCrisisBody: 'Yaşadıkların çok ağır gelebilir, ama bunu tek başına taşımak zorunda değilsin. Güvendiğin birine ulaşmayı ve bir ruh sağlığı uzmanından destek almayı düşünebilirsin.',
      aiyaCrisisResources: 'Acil bir tehlike varsa lütfen hemen 112 Acil Servisi ara.',
      ...
      aiyaChipGratitude: 'Minnettarlık anılarımı göster',
      ...
      // Interactive tour (Aiya guides the user through the real pages)
      tourStart: 'Turu Başlat',
      tourProgress: 'Adım {{current}} / {{total}}',
      tourWelcomeTitle: '{{greeting}}{{name}}, ben Aiya! 👋',
      tourWelcomeText: 'NICEBASE\'e hoş geldin! Ben senin anı asistanınım. İstersen sana evi hızlıca gezdireyim, sadece bir dakika sürecek.',
      tourVaultTabTitle: 'Anı Kasan',
      tourVaultTabText: 'Kaydettiğin anılar hep Kasa\'nda güvende. Hadi aç, aşağıdaki Kasa\'ya dokun 👇',
      tourTapHint: 'Kasa\'ya dokun',
      // Aiya "meet me" demo (no login, scripted taste of the conversation)
      aiyaDemoTitle: 'Bir de beni tanı 🧡',
      aiyaDemoText: 'Aiya seninle tanışmak istiyor.',
      aiyaDemoOpeningSeeded: 'İlk anını okudum{{name}} 🌟 Hayatını güzelleştirmek için attığın o küçük adım... bende koca bir gülümseme bıraktı. İşte ben tam bunun için buradayım: güzel anlarını seninle hatırlamak, zor günlerinde yanında olmak için.',
      aiyaDemoOpeningPlain: 'Merhaba{{name}}! Ben Aiya 🧡 Anılarını biriktirdikçe seni tanıyacağım; sonra moralin bozukken de, bir şeyi hatırlamak istediğinde de hep buradayım.',
      aiyaDemoChipWho: 'Sen kimsin?',
      aiyaDemoReplyWho: 'Ben senin küçük anı arkadaşınım. Anılarını okurum, aralarındaki güzel bağları görürüm, sana kendini hatırlatırım, geçmişini bilen sıcacık bir dost gibi. 🧡',
      aiyaDemoChipCheer: 'Beni neşelendir',
      aiyaDemoReplyCheer: 'Şunu hep hatırla: bugün küçücük bir şey yaptın ama aslında kocamandı, kendine iyi bakmayı seçtin. Bununla gurur duy. Yarın da buradayım, birlikte devam edeceğiz. ✨',
      aiyaDemoFooter: 'Ne zaman içini dökmek istersen, bir dokunuş kadar yakınım.',
      aiyaDemoTyping: 'Aiya yazıyor…',
      tourFinishTitle: 'Artık Hazırsın! 🎉',
      tourFinishText: 'Tur tamamlandı! En güzeli, ilk anını şimdi eklemek. Hazırsan başlayalım, bir şeye ihtiyacın olursa Aiya hep burada.',
      tourFinishCta: 'İlk anımı ekle ✨',
      tourFinishCtaMore: 'Yeni bir anı ekle',
      tourFinishLater: 'Şimdilik kapat',
      tourFinishTextDone: 'Harika bir başlangıç yaptın, ilk anın Kasa\'nda! İstersen bir tane daha ekle, ya da keşfetmeye başla.',
      // Do-first: seed the user's first memory in one tap
      tourFirstMemoryTitle: 'Hadi ilk anını yaratalım ✨',
      tourFirstMemoryText: 'En güzel başlangıç, güzel bir anıdır. Senin için bir tane hazırladım, beğenirsen tek dokunuşla kaydet.',
      tourSeedMemoryLabel: 'İlk anın',
      tourSeedMemoryText: 'Bugün NICEBASE\'e başladım ve güzel anılarımı biriktirerek hayatımı güzelleştirmeye karar verdim. 🌟',
      tourSeedSaveCta: 'Bunu kaydet',
      tourSeedSaving: 'Kaydediliyor…',
      tourSeedSkip: 'Sonra yazarım',
      tourSeedSavedNote: 'Kaydedildi',
      tourSeedError: 'İlk anın kaydedilemedi, bir daha dener misin?',
      tourSeedDoneTitle: 'İşte bu! İlk anın hazır 🎉',
      tourSeedDoneText: 'İlk anını Kasa\'na kaydettim, hem de bir çekirdek anı olarak. Hadi devam edelim!',
      tourSeedAlreadyTitle: 'Anıların Kasa\'nda 🌟',
      tourSeedAlreadyText: 'Zaten anı biriktirmeye başlamışsın, ne güzel! Hadi turumuza devam edelim.',
      ...
      resetLinkInvalid: 'Bu şifre sıfırlama bağlantısı geçersiz veya süresi dolmuş. Lütfen yeni bir bağlantı isteyin.',
      ...
      // --- full-audit-fixes: new keys ---
      // Home stat cards / vault
      viewTotalMemories: 'Tüm anıları gör',
      viewCoreMemories: 'Çekirdek anıları gör',
      coreOnly: 'Sadece çekirdek',
      // Export
      exportSavedToDocuments: 'Belgeler klasörüne kaydedildi',
      // Notifications
      notificationPermissionBlocked: 'Bildirim izni kapalı. Lütfen telefon ayarlarından NICEBASE için bildirimlere izin ver.',
      openSettings: 'Ayarları Aç',
      notificationStatusOn: 'Bildirimler açık',
      notificationStatusOff: 'Bildirimler kapalı',
      notificationChecking: 'Kontrol ediliyor…',
      // App lock
      appLock: 'Uygulama Kilidi',
      appLockDescription: 'Günlüğünü açmak için PIN iste',
      enableAppLock: 'Uygulama Kilidini Aç',
      disableAppLock: 'Uygulama Kilidini Kapat',
      setPin: 'PIN Belirle',
      changePin: 'PIN’i Değiştir',
      enterPin: 'PIN’i Gir',
      confirmPin: 'PIN’i Onayla',
      enterNewPin: 'Yeni PIN gir',
      enterCurrentPin: 'Mevcut PIN’i gir',
      pinMismatch: 'PIN’ler eşleşmiyor',
      incorrectPin: 'Yanlış PIN',
      pinTooShort: 'PIN en az 4 haneli olmalı',
      pinSet: 'PIN belirlendi',
      appLockEnabledMsg: 'Uygulama kilidi açıldı',
      appLockDisabledMsg: 'Uygulama kilidi kapatıldı',
      unlock: 'Kilidi Aç',
      forgotPin: 'PIN’i mi unuttun?',
      forgotPinInstructions: 'Kilidi sıfırlamak için çıkış yapıp tekrar giriş yapabilirsin. Anıların güvende kalır.',
      tooManyAttempts: 'Çok fazla deneme. Lütfen biraz bekle.',
      lockedTitle: 'NICEBASE Kilitli',
      lockedSubtitle: 'Devam etmek için PIN’ini gir',
      appLockPrivacyNote: 'Bu kilit gizlilik içindir, şifreleme değildir.',
      // Aiya limit (warm)
      aiyaLimitTitle: 'Şimdilik bu kadar',
      aiyaLimitCta: 'Premium’a göz at',
      aiyaWeeklyResetHint: 'Yeni haftalık sohbet hakların {{days}} gün sonra yenilenir',
      // Classification feedback
      'classification.failedRetry': 'Kategori atanamadı, tekrar denemek için dokun',
      'classification.retrying': 'Yeniden deneniyor…',
      'classification.retry': 'Tekrar dene',
      // Progress (merged Statistics + Achievements)
      insightsTitle: 'İlerleme',
      insightsSubtitle: 'İstatistiklerin ve başarımların tek yerde',
      insightsTabOverview: 'Genel Bakış',
      insightsTabTrends: 'Trendler',
      insightsTabGoals: 'Hedefler',
      profileInsightsDescription: 'İstatistiklerini ve başarımlarını gör',
      statsHighlights: 'Öne Çıkanlar',
      topCategory: 'En Çok Kategori',
      topConnection: 'En Çok Bağlantı',
      mostActiveMonth: 'En Aktif Ay',
      coreRatio: 'Çekirdek Oranı',
      vsLastMonth: 'geçen aya göre',
      statsPeriodMonth: 'Bu Ay',
      statsPeriodYear: 'Bu Yıl',
      statsPeriodAll: 'Tüm Zamanlar',
      goalsUnlocked: '{{count}} / {{total}} açıldı',
      insightsNoData: 'İstatistikler için birkaç anı ekle',
      daysSinceLastMemory: 'Son anıdan bu yana',
      // Relationship saver
      changeConnection: 'Bağlantıyı değiştir',
      // Premium / Paywall
      premiumTitle: 'NICEBASE Premium',
      premiumHeadline: 'Aiya ile sınırsız, tüm özellikler açık',
      premiumBenefitUnlimitedAiya: 'Aiya ile sınırsız sohbet',
      premiumBenefitPriority: 'Öncelikli AI sınıflandırma',
      premiumBenefitSupport: 'Geliştirmeyi destekle',
      premiumBenefitFuture: 'Gelecek tüm premium özellikler',
      restorePurchases: 'Satın Alımları Geri Yükle',
      choosePlan: 'Planını seç',
      premiumMonthly: 'Aylık',
      premiumYearly: 'Yıllık',
      premiumLifetime: 'Ömür Boyu',
      mostPopular: 'En Popüler',
      bestValue: 'En Avantajlı',
      premiumActive: 'Premium aktif',
      premiumThankYou: 'Premium olduğun için teşekkürler! 💛',
      purchaseComingSoon: 'Satın alma çok yakında açılıyor. Şimdilik planlara göz atabilirsin.',
      purchaseNotAvailableWeb: 'Satın alma yalnızca mobil uygulamada kullanılabilir',
      ...
      backspace: 'Sil',
      migrationSuccess: '{{count}} anı hesabına aktarıldı',
      migrationFailed: 'Anılar aktarılamadı, tekrar dene',
      memoriesDeleted: '{{count}} anı silindi',
      bulkDeletePartial: '{{count}} anı silinemedi',
      weeklySummaryOff: 'Kapalı',
  ...
  en: {
    translation: {
      ...
      authEmailNotConfirmed: 'Please confirm your email address first.',
      authEmailInUse: 'This email is already registered.',
      authWeakPassword: 'Password must be at least 6 characters.',
      authRateLimited: 'Too many attempts. Please try again shortly.',
      authNetworkError: 'A connection problem occurred. Check your internet.',
      ...
      connectionMemoryCount_one: '{{count}} memory',
      connectionMemoryCount_other: '{{count}} memories',
      lastUsed: 'Last used',
      ...
      memoriesDeleted_one: '{{count}} memory deleted',
      memoriesDeleted_other: '{{count}} memories deleted',
      ...
      dataDeletion: 'Account & Data Deletion',
      legal: 'Legal',
      ...
      loginRequiredForReminders: 'Login required to use reminders',
      syncing: 'Syncing...',
      ...
      showMemoryNow: 'Show now',
      showAnotherMemory: 'Another memory',
      thankYou: 'Thank you',
      thankYouForReminding: 'Thanks for reminding me of this memory! 💝',
      onThisDay: 'today',
      memoriesOnThisDay_one: '{{count}} memory',
      memoriesOnThisDay_other: '{{count}} memories',
      ...
      aiyaLimitReached: 'You’ve used your weekly chats with Aiya. Aiya loves talking with you 💛, if you’d like to keep going without limits, Premium is made for you, or we’ll be right here when the week resets.',
      aiyaRateLimited: 'You\'re going a bit fast 🙂 Please try again in a few seconds.',
      aiyaRetry: 'Retry',
      aiyaRemaining_one: '{{count}} message left',
      aiyaRemaining_other: '{{count}} messages left',
      aiyaRenameChat: 'Rename',
      aiyaWhatRemembers: 'What Aiya remembers',
      aiyaClearMemory: "Clear Aiya's memory",
      aiyaMemoryCleared: "Aiya's memory cleared",
      aiyaNoProfile: "Aiya doesn't know enough about you yet. The more you chat, the better it gets to know you.",
      aiyaChatsLoadError: "Couldn't load conversations",
      photoTooLarge: 'Photo is too large. Exceeds the 10MB limit (current: {{size}}MB)',
      photoUploadRateLimited: 'Too many photo upload requests. Please wait a moment.',
      replayTutorial: 'Replay tutorial',
      retryBackups: 'Retry backups',
      retryingBackups: 'Retrying backups...',
      backupIssuesTitle: 'Some memories are not backed up',
      backupIssuesMessage: '{{count}} memory failed to back up. Tap to retry.',
      backupRetryPartial: '{{count}} memory could not be backed up',
      backupRetrySuccess: 'All memories backed up',
      textMaxLength: 'Text must be at most {{count}} characters',
      noRecentMonthlyData: 'No memories in the last 6 months',
      aiyaNetworkError: 'A connection problem occurred. Check your internet and try again.',
      aiyaTyping: 'Aiya is typing...',
      aiyaChatOptions: 'Chat options',
      aiyaCrisisTitle: 'You are not alone',
      aiyaCrisisBody: 'What you are going through can feel overwhelming, but you do not have to carry it alone. Consider reaching out to someone you trust and to a mental-health professional.',
      aiyaCrisisResources: 'If you are in immediate danger, please call your local emergency number right away (e.g. 112 or 911).',
      ...
      resetLinkInvalid: 'This password reset link is invalid or expired. Please request a new one.',
      ...
      tourProgress: 'Step {{current}} / {{total}}',
      tourWelcomeTitle: '{{greeting}}{{name}}, I\'m Aiya! 👋',
      tourWelcomeText: 'Welcome to NICEBASE! I\'m your memory assistant. Want me to show you around? It only takes a minute.',
      tourVaultTabTitle: 'Your Memory Vault',
      tourVaultTabText: 'Your memories all live safely in your Vault. Let\'s open it. Tap Vault below 👇',
      tourTapHint: 'Tap the Vault',
      // Aiya "meet me" demo (no login, scripted taste of the conversation)
      aiyaDemoTitle: 'Now meet me 🧡',
      aiyaDemoText: 'Aiya wants to say hello.',
      aiyaDemoOpeningSeeded: 'I read your first memory{{name}} 🌟 That little step you took to brighten your life... it left me with a big smile. This is exactly why I\'m here: to remember your good moments with you, and to be by your side on the hard days.',
      aiyaDemoOpeningPlain: 'Hi{{name}}! I\'m Aiya 🧡 As you collect memories, I\'ll get to know you, then I\'m always here, whether you\'re feeling low or just want to remember something.',
      aiyaDemoChipWho: 'Who are you?',
      aiyaDemoReplyWho: 'I\'m your little memory companion. I read your memories, notice the lovely threads between them, and remind you of who you are, like a warm friend who knows your past. 🧡',
      aiyaDemoChipCheer: 'Cheer me up',
      aiyaDemoReplyCheer: 'Always remember: today you did something small that was actually huge, you chose to take care of yourself. Be proud of that. I\'ll be here tomorrow too, and we\'ll keep going together. ✨',
      aiyaDemoFooter: 'Whenever you want to open up, I\'m just a tap away.',
      aiyaDemoTyping: 'Aiya is typing…',
      tourFinishTitle: 'You\'re All Set! 🎉',
      tourFinishText: 'Tour complete! The best first step is adding your first memory. Ready when you are, and Aiya is always here if you need anything.',
      tourFinishCta: 'Add my first memory ✨',
      tourFinishCtaMore: 'Add another memory',
      tourFinishLater: 'Maybe later',
      tourFinishTextDone: 'You\'re off to a great start, your first memory is in your Vault! Add another, or start exploring.',
      // Do-first: seed the user's first memory in one tap
      tourFirstMemoryTitle: 'Let\'s make your first memory ✨',
      tourFirstMemoryText: 'The best beginning is a lovely memory. I\'ve written one for you, save it with a tap if you like.',
      tourSeedMemoryLabel: 'Your first memory',
      tourSeedMemoryText: 'Today I started NICEBASE and decided to brighten my life by collecting my happy memories. 🌟',
      tourSeedSaveCta: 'Save this one',
      tourSeedSaving: 'Saving…',
      tourSeedSkip: 'I\'ll write later',
      tourSeedSavedNote: 'Saved',
      tourSeedError: 'We couldn\'t save your first memory, want to try again?',
      tourSeedDoneTitle: 'There it is! Your first memory 🎉',
      tourSeedDoneText: 'I\'ve saved your first memory to your Vault, as a core memory, no less. Let\'s keep going!',
      tourSeedAlreadyTitle: 'Your memories are safe 🌟',
      tourSeedAlreadyText: 'You\'ve already started collecting memories, lovely! Let\'s continue the tour.',

      // --- full-audit-fixes: new keys ---
      // Home stat cards / vault
      viewTotalMemories: 'View all memories',
      viewCoreMemories: 'View core memories',
      coreOnly: 'Core only',
      // Export
      exportSavedToDocuments: 'Saved to Documents',
      // Notifications
      notificationPermissionBlocked: 'Notifications are off. Please enable notifications for NICEBASE in your phone settings.',
      openSettings: 'Open Settings',
      notificationStatusOn: 'Notifications on',
      notificationStatusOff: 'Notifications off',
      notificationChecking: 'Checking…',
      // App lock
      appLock: 'App Lock',
      appLockDescription: 'Require a PIN to open your journal',
      ...
      pinSet: 'PIN set',
      appLockEnabledMsg: 'App lock enabled',
      appLockDisabledMsg: 'App lock disabled',
      unlock: 'Unlock',
      forgotPin: 'Forgot PIN?',
      forgotPinInstructions: 'Log out and sign back in to reset the lock. Your memories stay safe.',
      tooManyAttempts: 'Too many attempts. Please wait a moment.',
      lockedTitle: 'NICEBASE Locked',
      lockedSubtitle: 'Enter your PIN to continue',
      appLockPrivacyNote: 'This lock is for privacy, not encryption.',
      // Aiya limit (warm)
      aiyaLimitTitle: 'That’s all for now',
      aiyaLimitCta: 'Explore Premium',
      aiyaWeeklyResetHint: 'Your weekly messages refresh in {{days}} days',
      // Classification feedback
      'classification.failedRetry': 'Couldn’t categorize, tap to retry',
      'classification.retrying': 'Retrying…',
      'classification.retry': 'Retry',
      // Progress (merged Statistics + Achievements)
      insightsTitle: 'Progress',
      insightsSubtitle: 'Your stats and achievements in one place',
      insightsTabOverview: 'Overview',
      insightsTabTrends: 'Trends',
      insightsTabGoals: 'Goals',
      profileInsightsDescription: 'View your stats and achievements',
      statsHighlights: 'Highlights',
      topCategory: 'Top Category',
      topConnection: 'Top Connection',
      mostActiveMonth: 'Most Active Month',
      coreRatio: 'Core Ratio',
      vsLastMonth: 'vs last month',
      statsPeriodMonth: 'This Month',
      statsPeriodYear: 'This Year',
      statsPeriodAll: 'All Time',
      goalsUnlocked: '{{count}} / {{total}} unlocked',
      insightsNoData: 'Add a few memories to see stats',
      daysSinceLastMemory: 'Since last memory',
      // Relationship saver
      changeConnection: 'Change connection',
      // Premium / Paywall
      premiumTitle: 'NICEBASE Premium',
      premiumHeadline: 'Unlimited Aiya, everything unlocked',
      premiumBenefitUnlimitedAiya: 'Unlimited chats with Aiya',
      premiumBenefitPriority: 'Priority AI categorization',
      premiumBenefitSupport: 'Support development',
      premiumBenefitFuture: 'All future premium features',
      ...
      premiumThankYou: 'Thanks for going Premium! 💛',
      purchaseComingSoon: 'Purchasing is coming very soon. For now, take a look at the plans.',
      purchaseNotAvailableWeb: 'Purchases are only available in the mobile app',
      ...
      oneTime: 'One-time',
      backspace: 'Delete',
      migrationSuccess: '{{count}} memories added to your account',
      migrationFailed: 'Could not transfer your memories, please try again',
      memoriesDeleted: '{{count}} memories deleted',
      bulkDeletePartial: '{{count}} memories could not be deleted',
      weeklySummaryOff: 'Off',
