...
const resources = {
  tr: {
    translation: {
      ...
      aiyaLimitReached: 'Bu dönem için mesaj limitine ulaştın. Daha sonra tekrar dene.',
  ...
  en: {
    translation: {
      ...
      aiyaLimitReached: 'You\'ve reached your message limit for now. Please try again later.',
