...
export default function Layout() {
  ...
  const isFullscreenRoute = location.pathname.startsWith('/add-memory') || location.pathname.startsWith('/aiya')
  const showNav = !(isModalOpen || isFullscreenRoute)
    ...
    >
      <main
        ...
        style={{
          ...
          paddingBottom: showNav ? '64px' : undefined,
